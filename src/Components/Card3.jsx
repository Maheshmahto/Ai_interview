          ...
          <div className='w-[60%]'>
            <div className='feedback1'>
              ...
              <div className='mt-4 flex items-center gap-4'>
                ...
                <button className='flex items-center bg-white text-black border-2 border-blue-500 rounded-lg font-bold cursor-pointer watch '><IoPlayCircleOutline className='text-sm' />Watch how it works</button>
              </div>
            </div>
          </div>
          <div className=' w-[50%] h-[90%] flex items-center gap-5 relative'>
            <img src={vector6} alt="" className='absolute bottom-72 right-15 w-25'/>
            <img src={vector6}alt="" className='absolute bottom-0 left-0 w-25'/>
