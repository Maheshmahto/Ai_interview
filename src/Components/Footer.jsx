    ...
    <div class="container">
        ...
        <div class="footer-section">
            ...
            <div class="social-icons">
                <a href="#" className='footer-icon bg-[#EFF6FF] rounded-lg'><i class="fab fa-linkedin"></i></a>
                <a href="#" className='footer-icon bg-[#EFF6FF] rounded-lg'><i class="fab fa-twitter"></i></a>
                <a href="#" className='footer-icon bg-[#EFF6FF] rounded-lg'><i class="fab fa-instagram"></i></a>
