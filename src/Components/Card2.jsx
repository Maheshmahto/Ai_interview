      ...
      <div className='feedback-resume'>
            ...
            <div className='feedback'>
                  <div className='feedback1'>
                    <h1 className='text-[#2563EB] text-sm border-lg size-fit bg-blue-50 rounded-3xl flex items-center gap-2 realtime'><BiSolidZap />Real-Time Feedback</h1>
                    <h2>Know your strength and areas of improvement instatly</h2>
                      ...
                      <button className='demo1'><IoPlayCircleOutline/>Watch Demo</button>
                      </div>
                  </div>
              </div>
