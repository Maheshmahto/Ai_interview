      ...
      {singUp ? (
        <div className="flex items-center justify-center ">
          <form
            ...
            className=" w-[510px] h-[570px] rounded-2xl  shadow-2xl login-page "
          >
            <div className="flex flex-col items-center justify-center login1-page">
              <div>
                ...
                <div className="flex flex-col login2-page">
                  ...
                  />
                  <span
                    className="relative left-[305px] bottom-10"
        ...
        <div className="flex items-center justify-center ">
          <form
            ...
            className=" w-[510px] h-[370px] rounded-2xl  shadow-2xl login-page "
          >
            <div className="flex flex-col items-center justify-center login1-page">
              <div>
                <div className="flex flex-col">
