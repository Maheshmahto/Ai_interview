  ...
  return (
    <>
      <Login />
      {
        ...
        <form onSubmit={handleSubmit}  className=" w-[510px] h-[570px] rounded-2xl  shadow-2xl login-page ">
          <div className="flex flex-col items-center justify-center login1-page">
            ...
            <div className="flex flex-col">
              ...
              <div className="flex flex-col login2-page" >
                ...
                <input
                  ...
                  required
                  onChange={(e) => handleChange2("user_email", e.target.value)}
              ...
              <div className="flex flex-col login2-page">
                ...
                <input
                  ...
                  onChange={(e) => handleChange2("user_password", e.target.value)}
              ...
              <div className="flex flex-col login2-page">
                ...
                <input
                  ...
                  onChange={(e) => handleChange2("phone_no", e.target.value)}
            ...
            >
              ...
              Already have an Accout ?  <span className="text-blue-600 cursor-pointer" onClick={handleSignUp}>Login to Your account</span> 
              </span>
         ...
         <form onSubmit={handleSubmit}  className=" w-[510px] h-[350px] rounded-2xl  shadow-2xl login-page ">
           <div className="flex flex-col items-center justify-center login1-page">
             ...
             <div className="login-btn flex flex-col items-center gap-1">
               ...
               <span className="text-red-600">
               don't have an account ?  <span className="text-blue-600 cursor-pointer" onClick={handleSignUp}>Sign Up Now</span> 
               </span>
